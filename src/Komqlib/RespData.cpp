 ...
 *
 *  SCCS Information:
 *  Date: 99/09/21	@(#) CRespData.C 1.0@(#)
 */
//---------------------------------------------------------------------+
//  File:     CRespData.cpp
//  Author:   Daniel R Creager
//  Written:  January 2000
//  Desc:     Implementation of the CRespData class. 
//
//
//  Dev Log: 
//
...
//---------------------------------------------------------------------+
void CRespData::setCommonParmSet(
					int		ai_queue_id,
					char*	as_msg_buffer,
					long*	al_data_length,
					BOOL    ab_xlate_key_values,
					BOOL    ab_data_receipt_requested,
					BOOL    ab_log_receipt_requested){
...
vb_data_receipt_requested	= ab_data_receipt_requested;
vb_log_receipt_requested	= ab_log_receipt_requested;
}
...
//---------------------------------------------------------------------+
CString* CRespData::getRestartKey(){
...
//  10/18/99  DRC Created original code. 
//---------------------------------------------------------------------+
void CRespData::setRestartKey(char* as_Arg1){
...
//  10/18/99  DRC Created original code. 
//---------------------------------------------------------------------+
CString* CRespData::getBitFlds(void){
...
//  10/18/99  DRC Created original code. 
//---------------------------------------------------------------------+
void CRespData::setBitFlds(CString*	as_Arg1){
...
//---------------------------------------------------------------------+
void CRespData::BitToChr(char* as_To, char* as_From){
//
...
//  10/11/99  DRC Created original code. 
//---------------------------------------------------------------------+
void CRespData::ChrToBit(char* as_To, char* as_From){
//
//  declare local variables
//
int	i, j;
